...
4. **Скриншоты.** Вставлены из приложения: в hero — `assets/img/main.png`, в галерее `#screens` — остальные 10. Вертикальные скриншоты пульта помечены `shot--tall`, чтобы не растягиваться на всю колонку.
